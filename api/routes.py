...
urlpatterns = [
    ...
    ################## SECTORES ECONOMICOS  #############################
    path('sectorEconomico/obtenerSectoresEconomicos/', SectorEconomicoApiview.as_view() ),
    path('sectorEconomico/crearSectorEconomico/', SectorEconomicoApiview.as_view()),
    path('sectorEconomico/obtenerSectorEconomico/<int:id>', SectorEconomicoApiview.as_view()),
    path('sectorEconomico/editarSectorEconomico/<int:id>', SectorEconomicoApiview.as_view()),
    path('sectorEconomico/eliminarSectorEconomico/<int:id>', SectorEconomicoApiview.as_view()),
]+[
    ################# DENOMINACIONES ###############################
